...
namespace EmployeeInformation.WPF.ViewModels
{
    public class AddEmployeeViewModel : ViewModelBase
    {
        ...
        public AddEmployeeViewModel(EmployeeStore employeeStore, ModalNavigationStore modalNavigationStore, EmployeesDbContextFactory contextFactory, SectorStore sectorStore, DepartmentStore departmentStore)
        {
